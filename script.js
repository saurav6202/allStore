...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const popupHTML = `
        <div class="popup-overlay" id="popupOverlay">
            ...
            <div class="popup-btn-con">
                <a href="#" id="shopOwnerBtn" class="popup-btn shop-owner shopOwnerBtn">Shop Owner</a>
                <a href="#" id="customerBtn" class="popup-btn customer customerBtn">Customer</a>
            </div>
            </div>
        </div>
    `;
  ...
  document.querySelectorAll(".shopOwnerBtn").forEach((btn) => {
    btn.addEventListener("click", () => {
      redirectTo("owner/owner.html");
    });
  });

  document.querySelectorAll(".customerBtn").forEach((btn) => {
    btn.addEventListener("click", () => {
